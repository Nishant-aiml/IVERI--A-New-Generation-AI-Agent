...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "IVERI Sovereign Teal",
  description: "Classic dark teal — the canonical IVERI look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "IVERI Sovereign Teal (Large)",
  description: "IVERI Sovereign Teal with bigger fonts and roomier spacing",
