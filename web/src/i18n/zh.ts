...
export const zh: Translations = {
  ...
  pluginsPage: {
    ...
    headline: "发现、安装、启用和更新 Hermes 插件（对齐 `iveri plugins` CLI）。",
    ...
    removeConfirm: "从 ~/.iveri/plugins/ 删除此插件？",
    removeHint: "仅可移除用户安装在 ~/.iveri/plugins 下的插件。",
  ...
  skills: {
    ...
    categories: "分类",
    filters: "筛选",
    noSkills: "未找到技能。技能从 ~/.iveri/skills/ 加载",
