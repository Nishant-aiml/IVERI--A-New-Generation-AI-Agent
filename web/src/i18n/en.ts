...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update IVERI",
    updateHermesConfirmMessage:
      "This runs iveri update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update IVERI?",
    updatingHermes: "Updating IVERI…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update IVERI plugins (`iveri plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.iveri/plugins/?",
    removeHint: "Only user-installed plugins under ~/.iveri/plugins can be removed.",
    ...
    catalogHint:
      "Curated, IVERI-reviewed plugins pinned to exact commits. Install from here for supply-chain-safe versions.",
    catalogSearchPlaceholder: "Search catalog...",
    catalogEmpty: "No catalog entries match.",
    catalogEmptyDocsLink: "Learn about IVERI plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.iveri/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that IVERI doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "Scanning IVERI session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run IVERI more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once IVERI sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "IVERI is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
