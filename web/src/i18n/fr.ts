...
export const fr: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Hermes (parité avec `iveri plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.iveri/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.iveri/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.iveri/skills/",
