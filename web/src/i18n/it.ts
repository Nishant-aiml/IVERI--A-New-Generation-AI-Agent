...
export const it: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Hermes (parità con `iveri plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.iveri/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.iveri/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.iveri/skills/",
