...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Hermes (equivalente a `iveri plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.iveri/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.iveri/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.iveri/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que IVERI no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa IVERI más",
