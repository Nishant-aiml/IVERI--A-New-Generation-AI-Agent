...
export default function SystemPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <ConfirmDialog
        ...
        description={
          updateInfo && updateInfo.behind && updateInfo.behind > 0
            ? `This will run 'iveri update' (${updateInfo.update_command}) and pull ${updateInfo.behind} new commit${updateInfo.behind === 1 ? "" : "s"}. The gateway restarts when the update finishes; the current session keeps its prompt cache until then.`
            : `This will run 'iveri update' (${updateInfo?.update_command ?? "iveri update"}) and restart the gateway when it finishes.`
        }
        ...
        <Card>
          <CardContent className="py-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-3 gap-x-6 text-sm">
              ...
              <div>
                <div className="text-xs uppercase tracking-wider text-muted-foreground">IVERI</div>
                <div className="flex items-center gap-2">
      ...
      <section className="flex flex-col gap-3">
        <H2 variant="sm" className="flex items-center gap-2 text-muted-foreground">
          <Globe className="h-4 w-4" /> Sovereign Portal
        </H2>
        <Card>
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 py-4">
            ...
            <ConfirmDialog
              ...
              title="Restore full IVERI backup?"
              description={`This will overwrite your current IVERI configuration, skills, sessions, and data with the contents of ${backupImportLabel(importConfirmTarget)}. This cannot be undone.`}
              destructive
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-muted-foreground max-w-prose">
                    ...
                    returns links to send the IVERI team. Pastes auto-delete
                    after 6 hours.
                  </span>
                </div>
              </div>
