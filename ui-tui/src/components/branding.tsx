...
const TAG_FULL = 'IVERI AI · Sovereign Intelligence Agent'
const TAG_MID = 'Sovereign Intelligence Agent'
const TAG_TINY = 'IVERI AI'
const HIDE_BELOW = 34
  ...
  const heroColumn = wide ? (
    <Box flexDirection="column" width="100%">
      ...
      <Text color={t.color.accent}>
        ...
        <Text color={t.color.muted}> · IVERI Intelligence</Text>
      </Text>
    ...
    <Box flexDirection="column" width="100%">
      ...
      {typeof info.update_behind === 'number' && info.update_behind > 0 && (
        <Text bold color={t.color.warn}>
          ...
          <Text bold color={t.color.warn}>
            {info.update_command || 'iveri update'}
          </Text>
          <Text bold={false} color={t.color.warn} dimColor>
            {' '}
            to update
