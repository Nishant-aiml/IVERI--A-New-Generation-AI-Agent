...
app = FastAPI(title="IVERI Agent", version=__version__, lifespan=_lifespan)
...
async def auth_middleware(request: Request, call_next):
    ...
    if (
        ...
        and not path.startswith("/api/artifacts")
...
from hermes_cli.web_routers import (  # noqa: E402
    ...
    sovereign_dashboard as _sovereign_dashboard_routes,
)
