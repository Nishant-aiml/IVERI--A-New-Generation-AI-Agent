...
def _add_top_level_flags(parser: argparse.ArgumentParser) -> None:
    ...
    inherited(parser, "--sovereign", action="store_true", default=False,
              help="Air-gapped sovereign mode: block all outbound network traffic and enforce local-only execution")
...
def _build_chat_parser(subparsers) -> argparse.ArgumentParser:
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with IVERI Agent")
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="iveri", description="IVERI Agent - AI assistant with tool-calling capabilities",
