...
def _render_browse_page(c: Console, deduped, page_items, page: int, total_pages: int,
    ...
    if official_count > 0 and page == 1:
        c.print(f"[bright_cyan]★ {official_count} official optional skill(s) from IVERI Sovereign Intelligence[/]")
    c.print()
...
_INSTALL_PANELS = {
    "official": (
        "[bold bright_cyan]This is an official optional skill maintained by IVERI Sovereign Intelligence.[/]\n\n"
