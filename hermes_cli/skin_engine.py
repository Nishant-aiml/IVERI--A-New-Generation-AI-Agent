...
# Branding shared by every IVERI built-in (mono/daylight override help_header).
_HERMES_BRANDING: Dict[str, str] = _branding(
    "IVERI", "⚡", "Goodbye! ⚡", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic IVERI — sovereign intelligence",
